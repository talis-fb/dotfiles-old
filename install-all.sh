...
echo '------------------------------------------------------------'
echo ''
echo ' # Para o LSP do Neovim, é necessário instalar via NPM os pacotes (globalmente)...'
...
echo ''
echo ' # Para o LSP de Lua é necessário instalar o lua e o lua-language-server'
echo ''
echo '------------------------------------------------------------'
